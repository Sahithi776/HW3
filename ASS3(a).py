#Make the search case InSensitive, i.e. 
#all occurrences of the searched word will be found regardless
# of the case, i.e. the search for "will" or "Will" 
#should return results containing all "will", "Will", "WILL"
